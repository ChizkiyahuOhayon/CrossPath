...
It checks that E0–E17 are all present, all JSON artifacts parse, all NPZ archives are readable, required headline artifacts exist, and no result file is silently empty.
